...
import { useEffect, useState } from "react";
import { FaLinkedin, FaGithub, FaWhatsapp } from "react-icons/fa"; // Importing LinkedIn, GitHub, and WhatsApp icons
    ...
    <>
      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          {/* Social Media Icons */}
          <div className="col-start-9 col-end-10 flex items-center justify-center space-x-4">
            <a
